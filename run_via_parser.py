...
if __name__ == '__main__':
    ...
    parser.add_argument('--DataModule_batchSize', type=int, default=2)  # 8 with UTAE ==> GPU: 9 GB, 2 for 4GB GPU
    ...
    trainer = pl.Trainer(
        ...
        # Fixed limits
        max_epochs=1,  # Changed from 200 to 2 for testing
...
#parser.add_argument('--DataModule_batchSize', type=int, default=4) ======> parser.add_argument('--DataModule_batchSize', type=int, default=2)
#max_time={'days': 6, 'hours': 23} ===> max_time={'days': 0, 'hours':5},